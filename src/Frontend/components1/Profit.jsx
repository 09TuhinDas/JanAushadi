...
function Profit() {
  ...
  return (
    <div class="Profit">
      <div class="w-auto z-auto">
        <div class="-mt-[575px] ml-[10px]  rounded-[14.897px] border-[rgba(0,_0,_0,_1)] border-solid border bg-[#fff] flex flex-grow flex-col text-[#000] font-normal text-center w-[323px] h-[85px] pt-[0] px-[2px] pb-[80px]">
